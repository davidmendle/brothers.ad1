      ...
      <div className="wrap">
        <div className="footer-grid">
          <div>
            ...
            <p>
              Brothers.ad builds custom AI agents, workflow automation, review protocols, sales follow-up systems, and
              operating software for businesses that want to increase efficiency without replacing their team.
            </p>
