...
export default function AuditForm() {
  ...
  return (
    <form className="audit-form" onSubmit={submitForm}>
      ...
      <label>
        What should your system handle first?
      ...
      <p className="form-note">This sends a Brothers.ad audit request and returns a confirmation ID immediately.</p>
      {status === "success" ? (
        <p className="form-success">Request received. Confirmation ID: {leadId}. We will follow up using the contact details provided.</p>
      ) : null}
