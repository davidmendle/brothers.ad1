...
const starterMessages = [
  {
    role: "assistant",
    content:
      "Hi, I am the Brothers.ad assistant. Ask about lead follow-up, operations, reputation workflows, or where automation should start."
  }
];
        ...
        <aside className="chat-panel" aria-label="AI chat assistant">
          <div className="chat-head">
            <div>
              ...
              <span>Operational automation guidance</span>
            </div>
          ...
          <form className="chat-input" onSubmit={sendMessage}>
            <input
              ...
              placeholder="Ask what to automate..."
